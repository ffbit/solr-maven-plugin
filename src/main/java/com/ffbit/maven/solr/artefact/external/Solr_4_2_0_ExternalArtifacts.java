...
public class Solr_4_2_0_ExternalArtifacts
    ...
    protected List<Artifact> getSolrExtractionArtifacts() {
        return Arrays.<Artifact>asList(
                new DefaultArtifact("org.apache.solr:solr-cell:jar:4.2.0")
        );
    }
    ...
    protected List<Artifact> getSolrClasteringArtifacts() {
        return Arrays.<Artifact>asList(
                new DefaultArtifact("org.apache.solr:solr-clustering:jar:4.2.0")
        );
    }
    ...
    protected List<Artifact> getSolrLangIdArtifacts() {
        return Arrays.<Artifact>asList(
                new DefaultArtifact("org.apache.solr:solr-langid:jar:4.2.0")
        );
    }
    ...
    protected List<Artifact> getSolrVelocityArtifacts() {
        return Arrays.<Artifact>asList(
                new DefaultArtifact("org.apache.solr:solr-velocity:jar:4.2.0")
        );
    }
